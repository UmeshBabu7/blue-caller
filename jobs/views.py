...
# OTP imports - COMMENTED OUT FOR NOW
...
def custom_login(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            # OTP functionality commented out for now
            ...
            # For now, just login the user directly
            login(request, user)
...
def custom_signup(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            # Create user and activate immediately (OTP disabled for now)
