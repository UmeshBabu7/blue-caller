...
class WorkerAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'phone_number', 'tagline', 'verified', 'average_rating']
...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ['id', 'customer', 'worker', 'appointment_date', 'status', 'shift_type']
...
class WorkerRatingAdmin(admin.ModelAdmin):
    list_display = ['id', 'worker', 'customer', 'rating', 'created_at']
    list_filter = ['rating', 'created_at']
    search_fields = ['worker__name', 'customer__name']

@admin.register(Service)
class ServiceAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'category', 'base_pricing_type']
...
class SubTaskAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'service', 'default_pricing_type']
    list_filter = ['default_pricing_type']
    search_fields = ['name', 'description']

@admin.register(WorkerService)
class WorkerServiceAdmin(admin.ModelAdmin):
    list_display = ['id', 'worker', 'service', 'is_available']
...
class WorkerSubTaskPricingAdmin(admin.ModelAdmin):
    list_display = ['id', 'worker_service', 'subtask', 'pricing_type', 'price', 'experience_level']
